...
describe ArrowPayments::Client do
  describe '#initialize' do
    ...
    it 'validates api mode' do
      expect { ArrowPayments::Client.new(:api_key => 'foobar', :mode => 'foobar') }.to raise_error "Invalid mode: foobar"
    end

    it 'sets production mode by default' do
      client = ArrowPayments::Client.new(:api_key => 'foobar')
  ...
  describe '#sanbox?' do
    it 'returns true if sandbox mode' do
      client = ArrowPayments::Client.new(:api_key => 'foobar', :mode => 'sandbox')
  ...
  describe '#production?' do
    it 'returns true if production mode' do
      client = ArrowPayments::Client.new(:api_key => 'foobar', :mode => 'production')
